...
#include "JoltMoverCVDSimDataSettings.generated.h"

/** Set of visualization flags options for JoltMover Sim Data */
UENUM(meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = "true"))
enum class EJoltMoverCVDSimDataVisualizationFlags : uint32
{
	None					= 0 UMETA(Hidden),
	EnableDraw				= 1 << 0,
};
ENUM_CLASS_FLAGS(EJoltMoverCVDSimDataVisualizationFlags);

UCLASS(config=ChaosVD, PerObjectConfig)
class UJoltMoverCVDSimDataSettings : public UChaosVDVisualizationSettingsObjectBase
{
	GENERATED_BODY()
...
public:
	...
	static void SetDataVisualizationFlags(EJoltMoverCVDSimDataVisualizationFlags NewFlags);
	static EJoltMoverCVDSimDataVisualizationFlags GetDataVisualizationFlags();
...
private:
	...
	UPROPERTY(config, meta = (Bitmask, BitmaskEnum = "/Script/JoltMoverCVDEditor.EJoltMoverCVDSimDataVisualizationFlags"))
	uint32 DebugDrawFlags = static_cast<uint32>(EJoltMoverCVDSimDataVisualizationFlags::None);
};