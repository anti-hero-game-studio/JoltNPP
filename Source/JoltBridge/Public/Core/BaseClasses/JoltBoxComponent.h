...
class JOLTBRIDGE_API UJoltBoxComponent : public UBoxComponent, public IJoltPrimitiveComponentInterface
{
	GENERATED_BODY()
...
public:
	...
	UJoltBoxComponent(const FObjectInitializer& ObjectInitializer);
