...
#include "JoltMoverBlackboard.generated.h"

#define UE_API JOLTMOVER_API



enum class EJoltInvalidationReason : uint8
{
...
class UJoltMoverBlackboard : public UObject
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	UE_API void Invalidate(EJoltInvalidationReason Reason);
	
	/** Invalidate all objects */
	void InvalidateAll() { Invalidate(EJoltInvalidationReason::FullReset); }
