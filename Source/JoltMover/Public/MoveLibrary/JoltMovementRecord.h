...
#pragma once
#include "JoltMovementRecord.generated.h"
...
struct FJoltMovementSubstep
{
	GENERATED_BODY()

	FJoltMovementSubstep() {}
	FJoltMovementSubstep(FName InMoveName, FVector InMoveDelta, bool InIsRelevant = true)
...
struct FJoltMovementRecord
{
	...
	UE_API void Append(FJoltMovementSubstep Substep);
	...
	const TArray<FJoltMovementSubstep>& GetSubsteps() const { return Substeps; }
...
private:
	...
	TArray<FJoltMovementSubstep> Substeps;
};
