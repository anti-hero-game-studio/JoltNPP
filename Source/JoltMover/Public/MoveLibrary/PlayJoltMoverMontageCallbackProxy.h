...
#include "PlayJoltMoverMontageCallbackProxy.generated.h"
...
// from the montage.
UCLASS(MinimalAPI)
class UPlayJoltMoverMontageCallbackProxy : public UPlayMontageCallbackProxy
{
	GENERATED_UCLASS_BODY()

	// Called to perform the query internally
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"))
	static UE_API UPlayJoltMoverMontageCallbackProxy* CreateProxyObjectForPlayMoverMontage(
