...
#include "JoltModularMovement.generated.h"
...
class UJoltTurnGeneratorInterface : public UInterface
{
	GENERATED_BODY()
};
 ...
 */
class IJoltTurnGeneratorInterface : public IInterface
{
	GENERATED_BODY()
...
public:
	...
	JOLTMOVER_API FVector GetTurn(FRotator TargetOrientation, const FJoltMoverTickStartData& FullStartState, const FJoltUpdatedMotionState& MoverState, const FJoltMoverTimeStep& TimeStep, const FJoltProposedMove& ProposedMove, UJoltMoverBlackboard* SimBlackboard);
};
...
class ULinearTurnGenerator : public UObject, public IJoltTurnGeneratorInterface
{
	GENERATED_BODY()
...
public:
	...
	UE_API virtual FVector GetTurn_Implementation(FRotator TargetOrientation, const FJoltMoverTickStartData& FullStartState, const FJoltUpdatedMotionState& MoverState, const FJoltMoverTimeStep& TimeStep, const FJoltProposedMove& ProposedMove, UJoltMoverBlackboard* SimBlackboard) override;
};
 ...
 */
UCLASS(MinimalAPI, BlueprintType, EditInlineNew)
class UExactDampedTurnGenerator : public UObject, public IJoltTurnGeneratorInterface
{
	GENERATED_BODY()
...
class UBlueprintableTurnGenerator : public UObject, public IJoltTurnGeneratorInterface
{
	GENERATED_BODY()
};
