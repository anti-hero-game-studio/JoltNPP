...
#include "NavJoltMoverComponent.generated.h"

#define UE_API JOLTMOVER_API

/**
 * NavMoverComponent: Responsible for implementing INavMoveInterface with UJoltMoverComponent so pathfinding and other forms of navigation movement work.
...
class UNavJoltMoverComponent : public UActorComponent, public INavMovementInterface
{
	GENERATED_BODY()

public:
	UE_API UNavJoltMoverComponent();
