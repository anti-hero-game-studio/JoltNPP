...
#include "JoltKinematicNavWalkingMode.h"
#include "JoltAsyncNavWalkingMode.generated.h"
...
class UJoltAsyncNavWalkingMode : public UJoltBaseMovementMode
{
	GENERATED_BODY()

public:
	UE_API UJoltAsyncNavWalkingMode();
	...
	UPROPERTY(Category = "NavMesh Movement", EditAnywhere, BlueprintReadWrite)
	EJoltOffNavMeshBehavior BehaviorOffNavMesh = EJoltOffNavMeshBehavior::SwitchToWalking;
...
protected:
	...
	TWeakObjectPtr<UNavJoltMoverComponent> NavMoverComponent;
	...
	UE_API void CaptureOutputState(const FJoltUpdatedMotionState& StartSyncState, const FVector& FinalLocation, const FRotator& FinalRotation, const FJoltMovementRecord& Record, const FVector& AngularVelocityDegrees, FJoltUpdatedMotionState& OutputSyncState, FJoltMoverTickEndData& OutputState) const;
