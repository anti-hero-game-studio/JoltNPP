...
#include "JoltKinematicNavWalkingMode.generated.h"
...
UENUM(BlueprintType)
enum class EJoltOffNavMeshBehavior : uint8
{
...
class UJoltKinematicNavWalkingMode : public UJoltBaseMovementMode
{
	GENERATED_BODY()

public:
	UE_API UJoltKinematicNavWalkingMode();
...
protected:
	...
	TObjectPtr<UNavJoltMoverComponent> NavMoverComponent;
	...
	UE_API void CaptureFinalState(USceneComponent* UpdatedComponent, const FJoltMovementRecord& Record, const FVector& AngularVelocityDegrees, FJoltUpdatedMotionState& OutputSyncState) const;
