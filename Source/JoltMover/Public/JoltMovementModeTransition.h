...
#include "JoltMovementModeTransition.generated.h"
...
struct FJoltTransitionEvalResult
{
	GENERATED_BODY()

	FJoltTransitionEvalResult() {}
	FJoltTransitionEvalResult(FName InNextMode) { NextMode = InNextMode; }
	...
	static UE_API const FJoltTransitionEvalResult NoTransition;
};
...
class UJoltBaseMovementModeTransition : public UObject
{
	GENERATED_BODY()
...
public:
	...
	template<typename MoverT = UJoltMoverComponent UE_REQUIRES(std::is_base_of_v<UJoltMoverComponent, MoverT>)>
	...
	UE_API FJoltTransitionEvalResult Evaluate(const FJoltSimulationTickParams& Params) const;

	UFUNCTION(BlueprintNativeEvent, Category = MovementModeTransition)
	UE_API void Trigger(const FJoltSimulationTickParams& Params);
...
protected:
	...
	virtual FJoltTransitionEvalResult OnEvaluate(const FJoltSimulationTickParams& Params) const final { return FJoltTransitionEvalResult::NoTransition; }
	...
	virtual void OnTrigger(const FJoltSimulationTickParams& Params) final {}
};
 ...
 */
UCLASS(MinimalAPI)
class UJoltImmediateMovementModeTransition : public UJoltBaseMovementModeTransition
{
	GENERATED_UCLASS_BODY()

public:
	UE_API virtual FJoltTransitionEvalResult Evaluate_Implementation(const FJoltSimulationTickParams& Params) const override;
	UE_API virtual void Trigger_Implementation(const FJoltSimulationTickParams& Params) override;
