...
#include UE_INLINE_GENERATED_CPP_BY_NAME(JoltModularMovement)


FVector ULinearTurnGenerator::GetTurn_Implementation(FRotator TargetOrientation, const FJoltMoverTickStartData& FullStartState, const FJoltUpdatedMotionState& MoverState, const FJoltMoverTimeStep& TimeStep, const FJoltProposedMove& ProposedMove, UJoltMoverBlackboard* SimBlackboard)
{
...
FVector UExactDampedTurnGenerator::GetTurn_Implementation(FRotator TargetOrientation, const FJoltMoverTickStartData& FullStartState, const FJoltUpdatedMotionState& MoverState, const FJoltMoverTimeStep& TimeStep, const FJoltProposedMove& ProposedMove, UJoltMoverBlackboard* SimBlackboard)
{
	FVector AngularVelocityDpS(FVector::ZeroVector);
